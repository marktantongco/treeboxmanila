...
const allServices = [
  ...
  },
  {
    ...
    slug: "paper-bags",
    description:
      "Our custom paper bags are perfect for retail stores, corporate events, and promotional giveaways. Printed in full color with your brand logo and design, our bags are available in various sizes, paper weights, and handle styles. We use high-quality kraft and art paper to ensure durability and a premium feel.",
  ...
  },
  {
    ...
    slug: "calendars",
    description:
      "Start the year right with professionally printed calendars featuring your company branding. Our calendars serve as year-round marketing tools that keep your brand visible on desks and walls. Choose from wall calendars, desk calendars, and poster calendars with various binding options.",
  ...
  },
  {
    ...
    slug: "posters",
    description:
      "Make a big impression with our high-quality poster printing services. Whether you need event posters, advertising posters, or retail displays, our offset printing delivers sharp details and vibrant colors even at large sizes. Available in various paper stocks and finishes.",
  ...
  },
  {
    ...
    description:
      "Complete your brand identity with professional stationery and menu printing. From restaurant menus that withstand daily use to corporate letterheads that make a professional impression, we print every piece with precision and care. Available in various paper stocks and finishing options.",
  ...
  },
  {
    ...
    description:
      "Add the finishing touch to your products with custom stickers and labels. Our offset printing process produces crisp, vibrant labels that enhance your product packaging. We offer die-cut stickers, roll labels, and sheet labels in various shapes, sizes, and materials including waterproof options.",
  ...
  },
  {
    ...
    items: [
      { name: "Calling Cards", detail: "Professional business cards with various finishes" },
          ...
          <ScrollReveal delay={0.2}>
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                asChild
                size="lg"
                className="bg-[var(--color-brand-amber)] hover:bg-[var(--color-brand-amber-light)] text-white font-semibold shadow-lg shadow-amber-500/30 transition-all duration-300 text-base group relative overflow-hidden"
              >
